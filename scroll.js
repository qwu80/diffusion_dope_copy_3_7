  ...
  let scene_0 = new ScrollMagic.Scene({
    ...
    .on('start', () => {
      if (sceneCount == 1.5) {
        ...
        concentration=50/3
        document.getElementById("slider_5").value=50
    ...
    .on('start', () => {
      if (sceneCount == 2) {
        ...
        document.getElementById("slider_13").value=110
        document.getElementById("add_h_text").value=(Math.pow(10,11)).toExponential(1)
        add_h(110)
